...
public class AvroToProtoSerializerITCase {
    ...
    //                        + "   {\"name\": \"length_limited\", \"type\": [\"string\", \"null\"],
    // \"default\": \"ho\"}\n"
    //                        + " ]\n";
    //
    //        //        String fieldString =
    ...
    //
    //        BigQueryProtoSerializer<GenericRecord> serializer = new
    // AvroToProtoSerializer(avroSchema);
    //
    ...
    //                        //                        + "   {\"name\": \"decimal\", \"type\":
    // {\"type\":
    //                        // \"bytes\", \"logicalType\": \"decimal\", \"precision\": 4,
    // \"scale\":
    //                        // 2}},\n"
    //                        //                        + "   {\"name\": \"uuid\", \"type\":
    // {\"type\":
    ...
    //                        } else {
    //                            System.out.println(
    //                                    "received an in stream error: " +
    // response.getRowErrorsList());
    //                        }
    //                    }
    //
    ...
    //        String fieldString =
    //                " \"fields\": [\n"
    //                        + "   {\"name\": \"name\", \"type\": {\"type\": \"array\", \"items\":
    ...
    public void testTimeSchemaMicroSecondsInsertion() throws Exception {
        ...
        String fieldString =
                " \"fields\": [\n"
                        + "   {\"name\": \"time\", \"type\": [{\"type\": \"array\", \"items\": \"long\"}]}"
                        + " ]\n";

        Schema avroSchema = getAvroSchemaFromFieldString(fieldString);
        BigQueryProtoSerializer<GenericRecord> serializer = new AvroToProtoSerializer(avroSchema);
        System.out.println(serializer.getDescriptorProto());
        DescriptorProtos.DescriptorProto beamResult =
                AvroToProtoSerializer.getBeamResult(avroSchema);
        System.out.println(beamResult);
        //            ProtoRows.Builder protoRowsBuilder = ProtoRows.newBuilder();
        //            List<GenericRecord> list = getRows(tableId);
        //            for (GenericRecord record : list) {
        //                System.out.println("Record read: [" + record + "]");
...
//        String fieldString =
//                " \"fields\": [\n"
//                        + "   {\"name\": \"time\", \"type\": {\"type\": \"long\", \"logicalType\":
// \"time-micros\"}}\n"
//                        + " ]\n";
//
//        Schema avroSchema = getAvroSchemaFromFieldString(fieldString);
...
//        String fieldString =
//                " \"fields\": [\n"
//                        + "{\"name\": \"array_of_records\", \"type\":{\"type\": \"array\",
// \"items\": "
...
//        String fieldString =
//                " \"fields\": [\n"
//                        + "   {\"name\": \"record_with_array\", \"type\": {\"name\":
// \"record_with_array_field\", \"type\": \"record\", \"fields\": [{\"name\": \"array_in_record\",
