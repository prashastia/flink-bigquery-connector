...
public class AvroToProtoSerializer implements BigQueryProtoSerializer<GenericRecord> {
    ...
    // BigQuery input have timestamp as microseconds since EPOCH,
    ...
    static String convertDateTime(Object value, boolean micros) {
        ...
        because essentially we have a timestamp -
        we just need to strip the timezone before insertion.
         */
    ...
    // .serialize() would successfully serialize it without any error indications.
    @VisibleForTesting
