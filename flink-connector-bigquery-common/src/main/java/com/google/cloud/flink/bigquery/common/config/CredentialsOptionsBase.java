...
@AutoValue
public abstract class CredentialsOptionsBase implements Serializable {
    ...
    public Credentials getCredentials() {
        return GoogleCredentialsSupplierBase.supplyCredentialsFromSources(
    ...
    public final boolean equals(Object obj) {
        ...
        final CredentialsOptionsBase other = (CredentialsOptionsBase) obj;
    ...
    /**
     * Creates a builder class for the {@link CredentialsOptionsBase} class.
     *
     * @return A builder class.
     */
    public static Builder builder() {
        return new AutoValue_CredentialsOptionsBase.Builder();
    }

    /** A builder class for the {@link CredentialsOptionsBase} class. */
    @AutoValue.Builder
    public abstract static class Builder {
        ...
        /**
         * Builds a fully initialized {@link CredentialsOptionsBase} instance.
         *
         * @return The {@link CredentialsOptionsBase} instance.
         */
        public abstract CredentialsOptionsBase build();
    }
}
