...
import com.google.cloud.flink.bigquery.common.utils.SchemaTransformBase;
...
public class BigQueryServicesImpl implements BigQueryServices {
    ...
    @Override
    public StorageReadClient getStorageClient(CredentialsOptionsBase credentialsOptions)
            throws IOException {
        return new StorageReadClientImpl(credentialsOptions);
    }

    @Override
    public QueryDataClient getQueryDataClient(CredentialsOptionsBase creadentialsOptions) {
    ...
    public static class StorageReadClientImpl implements StorageReadClient {
        ...
        private StorageReadClientImpl(CredentialsOptionsBase options) throws IOException {
    ...
    public static class QueryDataClientImpl implements QueryDataClient {
        ...
        public QueryDataClientImpl(CredentialsOptionsBase options) {
            bigQuery =
                                ...
                                tp ->
                                        Optional.of(
                                                new TablePartitionInfo(
                                                        tp.getField(),
                                                        BigQueryPartitionUtilsBase.PartitionType
                                                                .valueOf(tp.getType()),
                                                        BigQueryPartitionUtilsBase
        ...
        public TableSchema getTableSchema(String project, String dataset, String table) {
            return Optional.ofNullable(bigQuery.getTable(TableId.of(project, dataset, table)))
                    ...
                    .map(schema -> SchemaTransformBase.bigQuerySchemaToTableSchema(schema))
                    .orElseThrow(
                            () ->
