...
import com.google.cloud.flink.bigquery.common.utils.BigQueryStateSerdeBase;
...
public class BigQuerySourceEnumStateSerializer
    ...
    public byte[] serialize(BigQuerySourceEnumState state) throws IOException {
        try (ByteArrayOutputStream baos = new ByteArrayOutputStream();
            ...
            BigQueryStateSerdeBase.serializeList(
            ...
            BigQueryStateSerdeBase.serializeMap(
                    out,
