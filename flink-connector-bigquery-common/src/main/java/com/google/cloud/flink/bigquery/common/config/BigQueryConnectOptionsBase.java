...
@PublicEvolving
public abstract class BigQueryConnectOptionsBase implements Serializable {
    ...
    @Nullable
    public abstract CredentialsOptionsBase getCredentialsOptions();
    ...
    public final boolean equals(Object obj) {
        ...
        final BigQueryConnectOptionsBase other = (BigQueryConnectOptionsBase) obj;
    ...
    public static Builder builder() throws IOException {
        return new AutoValue_BigQueryConnectOptionsBase.Builder()
    ...
    public abstract static class Builder {
         ...
         * @return A BigQueryConnectOptions builder instance
         */
        public abstract Builder setCredentialsOptions(CredentialsOptionsBase options);
         ...
         */
        public abstract BigQueryConnectOptionsBase build();
    }
}
