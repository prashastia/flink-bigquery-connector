...
public class StorageClientFaker {
    ...
    public static class FakeBigQueryServices implements BigQueryServices {
        ...
        @Override
        public StorageReadClient getStorageClient(CredentialsOptionsBase readOptions)
                throws IOException {
            return storageReadClient;
        }

        @Override
        public QueryDataClient getQueryDataClient(CredentialsOptionsBase readOptions) {
                                ...
                                pId ->
                                        new PartitionIdWithInfoAndStatus(
                                                ...
                                                retrievePartitionColumnInfo(project, dataset, table)
                                                        .get(),
                                                BigQueryPartitionUtilsBase.PartitionStatus.COMPLETED))
