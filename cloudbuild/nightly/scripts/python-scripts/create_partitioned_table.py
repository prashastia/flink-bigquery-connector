...
def create_partitioned_table(table_id):
    ...
    # This will not raise an exception in case of absence of the table.
    client.delete_table(table_id, not_found_ok=True)

    # Hardcoded for the purpose fo our test case.
    ...
    table.time_partitioning = bigquery.TimePartitioning(
        ...
        expiration_ms=1000 * 60 * 60 * 24 * 7 * 2,
...
def main(argv: Sequence[str]) -> None:
    ...
    number_of_threads = 4
    number_of_rows_per_batch = number_of_rows_per_partition // number_of_threads
    ...
    now_timestamp = execution_timestamp - datetime.timedelta(days=2)
