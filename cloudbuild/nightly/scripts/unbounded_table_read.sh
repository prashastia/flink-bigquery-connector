...
# Run python script to create the partitioned table and insert values.
python3 cloudbuild/nightly/scripts/python-scripts/create_partitioned_table.py -- --project_name "$PROJECT_NAME" --dataset_name "$DATASET_NAME" --table_name "$TABLE_NAME"
